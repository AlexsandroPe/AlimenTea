  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <TouchableOpacity onPress={() => alterarCheckbox('proteinas')} style={styles.checkboxRow}>
          <View style={[styles.checkbox, categorias.proteinas && styles.checkedBox]} />
          <Text style={styles.checkboxLabel}>Proteínas</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => alterarCheckbox('vegetais')} style={styles.checkboxRow}>
          <View style={[styles.checkbox, categorias.vegetais && styles.checkedBox]} />
          <Text style={styles.checkboxLabel}>Vegetais e Legumes</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => alterarCheckbox('carboidratos')} style={styles.checkboxRow}>
          <View style={[styles.checkbox, categorias.carboidratos && styles.checkedBox]} />
          <Text style={styles.checkboxLabel}>Grãos, Massas e Tubérculos</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => alterarCheckbox('temperos')} style={styles.checkboxRow}>
          <View style={[styles.checkbox, categorias.temperos && styles.checkedBox]} />
          <Text style={styles.checkboxLabel}>Temperos, Molhos e Complementos</Text>
        </TouchableOpacity>

        <Text style={styles.titlesimple}>Restrições Alimentares</Text>

        <TouchableOpacity onPress={() => setContGluten(!contGluten)} style={styles.checkboxRow}>
          <View style={[styles.checkbox, contGluten && styles.checkedBox]} />
          <Text style={styles.checkboxLabel}>Contém Glúten</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => setContLactose(!contLactose)} style={styles.checkboxRow}>
